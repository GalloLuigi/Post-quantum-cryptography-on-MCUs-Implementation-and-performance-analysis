...
#include "FireSaber/poly.h"
#include "FireSaber/rng.h"
#include "FireSaber/SABER_indcpa.h"
#include "FireSaber/verify.h"
#include "FireSaber/SABER_params.h"
...
void setup()
{
     ...
     for (int i = 0; i < WORD_NUMBER; i++)
    {
        ...
        startTime = micros();
        xTaskCreate(taskKeypair, "KeypairTask", 25000, NULL, 1, &taskHandleKeypair);
        endTime = micros();
        ...
        startTime = micros();
        xTaskCreate(taskEncrypt, "EncryptTask", 25000, NULL, 1, &taskHandleEncrypt);
        endTime = micros();
        ...
        startTime = micros();
        xTaskCreate(taskDecrypt, "DecryptTask", 30000, NULL, 1, &taskHandleDecrypt);
        endTime = micros();
